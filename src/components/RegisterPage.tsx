        ...
        <div className="flex items-center gap-1.5">
          {filteredBills.length > 0 && (
            <button
              ...
              className="p-1.5 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 text-emerald-800 rounded-xl text-xs font-bold flex items-center gap-1 transition-colors active:scale-95 cursor-pointer"
            >
          ...
          <span className="text-xs font-extrabold bg-emerald-100 text-emerald-800 px-2.5 py-1 rounded-xl">
            {bills.length} {language === 'ta' ? 'பில்கள்' : 'Bills'}
          </span>
        </div>
      </div>
      ...
      <div className="relative mb-3">
        ...
        {searchQuery && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-gray-400 hover:text-gray-600 px-1 cursor-pointer"
          >
            ✕
          </button>
        )}
          ...
          {filteredBills.map((bill) => (
            ...
            >
              ...
              <div className="py-2 text-[11px] text-gray-600 flex items-center justify-between">
                <span>
                  <strong className="text-emerald-900">{bill.items.length}</strong> {language === 'ta' ? 'பொருட்கள்' : 'items'} •{' '}
              ...
              <div className="grid grid-cols-3 gap-1.5 pt-2 border-t border-emerald-100">
                <button
                  ...
                  className="py-2 px-2 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white rounded-xl text-xs font-black flex items-center justify-center gap-1 transition-colors active:scale-95 shadow-sm shadow-emerald-600/20 cursor-pointer"
                ...
                <button
                  ...
                  type="button"
                  onClick={() => onReprintBill(bill)}
                  className="py-2 px-2 bg-emerald-800 hover:bg-emerald-900 active:bg-emerald-950 text-white rounded-xl text-xs font-black flex items-center justify-center gap-1 transition-colors active:scale-95 shadow-sm shadow-emerald-900/20 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="py-2 px-2 bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white rounded-xl text-xs font-black flex items-center justify-center gap-1 transition-colors active:scale-95 shadow-sm shadow-rose-600/20 cursor-pointer"
                >
