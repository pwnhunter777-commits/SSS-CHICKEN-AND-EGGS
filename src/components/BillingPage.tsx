      ...
      <div className="bg-white border-2 border-emerald-300 rounded-3xl p-4 shadow-sm mb-3 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white rounded-xl text-xs font-black flex items-center gap-1 transition-all active:scale-95 shadow-md shadow-emerald-700/20 cursor-pointer"
          >
        ...
        <div className="relative">
          <select
            ...
            className="w-full min-h-[50px] px-4 pr-10 bg-emerald-50/80 hover:bg-emerald-100/70 border-2 border-emerald-500 focus:border-emerald-700 focus:bg-white rounded-2xl text-sm sm:text-base font-black text-emerald-950 outline-none appearance-none transition-colors cursor-pointer shadow-xs leading-normal"
          >
            ...
            >
              ...
              <div className="flex items-center justify-between gap-1.5">
                <div className="min-w-0 flex-1 flex items-center gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {language === 'ta' && product.nameEn && product.nameEn !== product.nameTa && (
                      <p className="text-xs text-emerald-800/80 font-bold truncate leading-tight">
                        {product.nameEn}
                      </p>
                    )}
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 min-h-[36px] rounded-xl text-xs font-black transition-all active:scale-95 touch-manipulation shadow-xs bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white flex-shrink-0 cursor-pointer"
              ...
              <div className="grid grid-cols-3 gap-1.5 sm:gap-2.5 pt-0.5">
                ...
                <div className="flex flex-col">
                  <label
                    ...
                    className="text-xs sm:text-sm font-black uppercase text-emerald-950 bg-emerald-100/90 py-1 px-1 rounded-lg mb-1 text-center tracking-wider block leading-none truncate"
                  >
                  ...
                  <input
                    ...
                    placeholder="KG"
                    className={`w-full min-h-[46px] px-2 py-2 rounded-xl text-base sm:text-lg font-black text-emerald-950 outline-none text-center transition-all border-2 flex items-center justify-center leading-normal ${
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    placeholder="RATE"
                    className="w-full min-h-[46px] px-2 py-2 bg-emerald-50/60 hover:bg-emerald-50/90 focus:bg-white border-2 border-emerald-400/90 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/20 rounded-xl text-base sm:text-lg font-black text-emerald-950 outline-none text-center shadow-2xs transition-all placeholder:text-emerald-400 flex items-center justify-center leading-normal"
                  />
                </div>
              </div>
            </div>
      ...
      <div className="mt-4 sticky bottom-20 z-20 bg-white/95 backdrop-blur-md border-2 border-emerald-300 rounded-3xl p-4 shadow-xl shadow-emerald-950/10">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <button
            ...
            disabled={activeBillItems.length === 0}
            className="min-h-[48px] py-3 px-3 bg-emerald-800 hover:bg-emerald-900 active:bg-emerald-950 disabled:opacity-40 disabled:cursor-not-allowed text-white font-black text-sm sm:text-base rounded-2xl shadow-md shadow-emerald-800/25 flex items-center justify-center gap-2 transition-all active:scale-98 cursor-pointer"
          >
