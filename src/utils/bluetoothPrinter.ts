...
// Convert HTML element to ESC/POS raster bitmap commands
...
// Clean text generator for fallback ESC/POS text mode
...
export const printThermalReceiptViaBluetooth = printViaBluetooth;
